...
public class CtBasePpomService extends BaseService {

	private static final String NAME = "PPOMPPU Baseball";
	private static final String HOST = "http://m.ppomppu.co.kr/new/";
	private static final String URL = "http://m.ppomppu.co.kr/new/bbs_list.php?id=baseball";
	...
	public CtBasePpomService(int intervalTime) {
